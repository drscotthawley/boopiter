...
# AUTOGENERATED! DO NOT EDIT! File to edit: ../nbs/05_plugins.ipynb.

# %% auto #0
__all__ = ['PLUGINS', 'Plugin', 'register', 'start_plugins', 'SystemMonitor']

# %% ../nbs/05_plugins.ipynb #0290e988
