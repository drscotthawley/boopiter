...
# %% auto #0
__all__ = ['daisy_hdrs', 'app', 'rt', 'p', 'CTYPES', 'nb', 'BORDER', 'run_code', 'Cell', 'Notebook', 'get_model_list',
           'prompt_llm', 'llm_context', 'stub_reply', 'ensure_models', 'IconBtn', 'cell_toolbar', 'type_dropdown',
           'cell_header', 'cell_body', 'code_editor', 'render_cell', 'render_cell_edit', 'render_nb', 'composer',
           'render_app', 'theme_swap', 'save_notebook', 'load_notebook', 'fname_display', 'rename_form',
           'model_dropdown', 'set_model', 'top_bar', 'boopiter_ping', 'logo_png', 'index', 'save_now', 'rename',
           'restart_kernel', 'interrupt_kernel', 'set_type', 'run_prompt_cell', 'add_cell', 'submit_cell', 'split',
           'run_cell', 'toggle_vis', 'del_cell', 'move_cell', 'select', 'select_delta', 'insert', 'del_selected',
...
# %% ../nbs/01_cells.ipynb #6f3304b8-c0e3-4132-94c9-a20da887a3d8
...
# %% ../nbs/01_cells.ipynb #60781961-5f10-469e-82d9-dc1f53a66f5a
...
# %% ../nbs/01_cells.ipynb #6231a5d5-e6c7-4561-a48c-85f4890acb4a
