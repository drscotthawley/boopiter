...
__all__ = ['daisy_hdrs', 'app', 'rt', 'p', 'CTYPES', 'nb', 'BROWSE_ROOT', 'BORDER', 'ICONS', 'run_code', 'Cell', 'Notebook',
           ...
           'download', 'rename', 'restart_kernel', 'interrupt_kernel', 'set_type', 'run_prompt_cell', 'add_cell',
           'submit_cell', 'split', 'run_cell', 'toggle_vis', 'del_cell', 'move_cell', 'select', 'select_delta',
           'insert', 'del_selected', 'settype_selected', 'set_ctype', 'edit_cell', 'view_cell', 'save_cell']
...
def cell_toolbar(c):
    ...
    btns = [copy_btn, IconBtn('eye' if c.visible else 'eye-slash',
