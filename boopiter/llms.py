...
# %% auto #0
__all__ = ['DEFAULT_TOOL_SELECTION', 'OLLAMA_URL', 'get_tool_list', 'ollama_loaded', 'unload_ollama_model', 'sync_ollama_loaded',
           'get_ollama_list', 'get_model_list', 'tools_system_prompt', 'prompt_llm', 'stream_llm_reply']
...
def sync_ollama_loaded(keep:list) -> list[str]:
    ...
    keep = {m.removeprefix('ollama/') for m in keep if m}
