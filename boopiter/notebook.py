...
class Notebook:
    ...
    def __init__(self):
        ...
        self.num_ctx = 32768  # context window (tokens) requested from Ollama -- picked in the brain menu (see _num_ctx_control()). Not free: the KV cache is allocated for the whole window, so this is the single biggest lever on how much RAM a loaded model occupies (qwen3-vl:4b at its native 262144 sits at ~46GB; at 32768 it's ~8GB)
